      ...
      <div className="aboutMain">
        <Grid container className="aboutInner">
          <Grid item md={12} className="aboutDesp">
            ...
            security through advanced reconnaissance, consulting, and defensive
            security services through Operational Security (OPSEC). Founded in
            2020 by a group of hackers, people all over the world have taken
            their first steps to understanding what information about them is
            out there.
          </Grid>
        ...
        <Grid container className="aboutInner">
          <Grid container item md={12} sm={12} xs={12} className="topicDiv">
            ...
            <Grid item md={7} sm={12} xs={12} className="topicText">
              ...
              perspective, taking into consideration your objectives and unique
              constraints
            </Grid>
          </Grid>
          ...
          <Grid container item md={12} sm={12} xs={12} className="topicDiv">
            ...
            <Grid item md={7} sm={12} xs={12} className="topicText">
              ...
              things as personal protection, removing information that seeks to
              harm your current opportunities in life, keeping your business and
              employees safe from leaked information, competitive disadvantages,
              or public embarrassment. Maybe you want internet anonymity and you
              want to disappear. Go-Dark can help.
            </Grid>
          </Grid>
        </Grid>
      </div>
